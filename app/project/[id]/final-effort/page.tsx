...
const scopeEffort = project.scopeAnswers.map((answer) => {
  ...
  const localizationTotal = localizationEffort.reduce(
    (sum, row) => sum + row.effort,
    0
  );
  const developmentTotal = developmentEffort.reduce(
    (sum, row) => sum + row.effort,
    0
  );
    ...
    <main style={{ maxWidth: 1000, margin: "40px auto", fontFamily: "Arial" }}>
      ...
      >
        ...
        <tbody>
          ...
          <tr>
            <td colSpan={2}>
              <strong>Project Effort Toplamı</strong>
            </td>
            <td>
          ...
          <tr>
            <td colSpan={2}>
              <strong>Localization Effort Toplamı</strong>
            </td>
            <td>
              <strong>{localizationTotal}</strong>
            </td>
          </tr>

          <tr>
            <td colSpan={2}>
              <strong>Development Effort Toplamı</strong>
            </td>
            <td>
              <strong>{developmentTotal}</strong>
            </td>
          </tr>
